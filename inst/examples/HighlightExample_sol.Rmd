...
Providing a specific class **overrides** the base class. If one wants to add to the base class or chain multiple self-defined classes this is possible too using the underlying css mechanic: 
