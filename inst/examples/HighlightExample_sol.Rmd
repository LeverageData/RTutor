...
This is a more extensive guide on how to use *highlight* blocks. The source code of this file can be found in the corresponding github-folder: <https://github.com/LeverageData/RTutor/blob/master/inst/examples/HighlightExample_sol.Rmd>. The compiled version can be found at <https://leveragedata.shinyapps.io/HighlightExample/>.

#< highlight "Attention!"

To avoid interpretation in the examples we write `_#<` to start a block and `_#>` to end it. To actually create an highlighting block, `#\<` and `#\>` have to be used.
