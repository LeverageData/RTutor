...
Note that an exception is made for the automatic numbering of RMD. Writing "3." as has been done here therefore does not translate to the automatic labeling of RMD which would default to 1. Instead the actually written number is displayed. 
...
2. **Shorthand:** Display a message as soon as a specific answer is chosen, independent on other answers (as long as the solution is not correct).
  * choice_commentary{6}: Text
      + Is identical to choice_commentary{6 %in% chosen)}: Text
